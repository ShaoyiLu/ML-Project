...
BEST_PATH = os.path.join(SAVE_DIR, "modelB_2_expert_best_lowlr.pth")
LAST_PATH = os.path.join(SAVE_DIR, "modelB_2_expert_last_lowlr.pth")
...
def train_model(
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        print(
            f"ModelB-2-lowlr | Epoch {epoch:03d} | "
        ...
        if val_acc > best_acc + 0.03:
            ...
            print(f"Saved new best ModelB-2-lowlr: {best_acc:.2f}%")
        else:
            bad_epochs += 1
    ...
    print(f"\nBest ModelB-2-lowlr Val Accuracy = {best_acc:.2f}% at epoch {best_epoch}")
...
def main():
    ...
    print(f"\nFinal ModelB-2-lowlr Validation Accuracy: {final_acc:.2f}%")
    ...
    print(f"\nSaved ModelB-2-lowlr best model to {BEST_PATH}")
